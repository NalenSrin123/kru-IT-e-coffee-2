...
const defaultCategories = ["All", "Hot Coffee", "Iced Coffee", "Non-Coffee Drinks", "Desserts"];
                            ...
                            >
                                ...
                                <div className="p-5 flex flex-col grow">
                                    ...
                                    <div className="flex justify-between items-center mt-4 pt-3">
                                        ...
                                        <button className="bg-[#8B5E3C] hover:bg-amber-700 text-white px-4 py-2 rounded-xl text-sm transition cursor-pointer">
                                            + Add
                                        </button>
                                    </div>
                                </div>
