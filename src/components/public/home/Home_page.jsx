      ...
      <section className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16 py-16 lg:py-24">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center md:text-left">
            ...
            <button className="mt-8 bg-[#F4B860] hover:bg-[#e5a84f] text-black font-medium px-7 py-3 rounded-xl shadow-md transition duration-300 hover:scale-105">
              Learn More
            </button>
          </div>
          ...
          {[
            ...
            <div key={index} className="overflow-hidden rounded-lg">
              <img
                ...
                alt="Gallery"
                className="w-full h-40 sm:h-52 md:h-60 object-cover transition-transform duration-300 hover:scale-110"
              />
            </div>
          ))}
        </div>
      ...
      <section className="max-w-4xl mx-auto px-6 sm:px-10 lg:px-16 pb-20">
        <div className="relative text-gray-700">
          ...
          <p className="pl-10 sm:pl-16 text-base sm:text-lg italic leading-relaxed">
            ...
            brews is a treat for the taste buds. Highly recommended!
          </p>

          <div className="mt-6 pl-10 sm:pl-16">
            <p className="font-semibold text-gray-800">Bunheng Sreng</p>
