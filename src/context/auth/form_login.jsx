        ...
        <div className="p-6 sm:p-10 flex flex-col justify-center relative bg-[#f9f7f3]">
          ...
          <form onSubmit={handleLogin} className="flex flex-col">
            ...
            <input
              ...
              className="mb-4 px-4 py-2 rounded-lg border border-gray-400 outline-none focus:ring-2 focus:ring-[#6B4226]"
            />
            ...
            <div className="relative mb-4">
              <input
                ...
                className="w-full px-4 py-2 rounded-lg border border-gray-400 outline-none focus:ring-2 focus:ring-[#6B4226]"
              />
              <button
                type="button"
